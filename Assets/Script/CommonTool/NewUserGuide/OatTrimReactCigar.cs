...
public class OatTrimReactCigar : SakeUIDaddy
{
    public static OatTrimReactCigar instance;
...
[UnityEngine.Serialization.FormerlySerializedAs("Text")]
    ...
    private float StudioHabit= 1;
    private float StudioRevere= 1;
    public void Wine(GameObject _target)
    {
        ...
        else
        {
            ...
            License[0] = new Vector3(pos.x - StudioHabit, pos.y - StudioRevere);
            License[1] = new Vector3(pos.x - StudioHabit, pos.y + StudioRevere);
            License[2] = new Vector3(pos.x + StudioHabit, pos.y + StudioRevere);
            License[3] = new Vector3(pos.x + StudioHabit, pos.y - StudioRevere);
        }
        //计算高亮显示区域在画布中的范围
