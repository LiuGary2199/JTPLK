...
public class DeathValley : MonoBehaviour
{
    ...
    /// <returns></returns>
    public static Transform FindNorModalCorn(GameObject goParent,string childName)
    {
        //查找结果
        ...
        if (searchTrans == null)
        {
            ...
            {
                searchTrans = FindNorModalCorn(trans.gameObject, childName);
                if (searchTrans != null)
                {
                    return searchTrans;
                }
    ...
    /// <returns></returns>
    public static T AshNorModalCornKatherineSuggest<T>(GameObject goParent,string childName) where T:Component
    {
        //查找特定子节点
        Transform searchTranformNode = null;
        searchTranformNode = FindNorModalCorn(goParent, childName);
    ...
    /// <param name="childName">子对象名称</param>
    /// <returns></returns>
    public static T PitModalCornKatherine<T>(GameObject goParent,string childName) where T : Component
    {
        Transform searchTransform = null;
        searchTransform = FindNorModalCorn(goParent, childName);
    ...
    public static void PitModalCornGoBelugaCorn(Transform parents,Transform child)
    {
