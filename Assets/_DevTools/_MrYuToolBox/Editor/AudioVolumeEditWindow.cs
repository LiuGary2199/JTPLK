...
public class AudioVolumeEditWindow : EditorWindow
{
    ...
    Dictionary<string, GroupRider> UIAudioGroup;
    Dictionary<string, GroupRider> SceneAudioGroup;
    //序列化对象
    ...
    {
        UIAudioGroup = new Dictionary<string, GroupRider>();
        SceneAudioGroup = new Dictionary<string, GroupRider>();
        ...
        Dictionary<string, GroupRider> audioDic = new Dictionary<string, GroupRider>();
        if (FileInfo.Exists)
        {
        ...
        //UI
        foreach(object music in Enum.GetValues(typeof(ShootMuch.UIMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            GroupRider model = new GroupRider();
        ...
        // Scene
        foreach (object music in Enum.GetValues(typeof(ShootMuch.SceneMusic)))
        {
            string name = music.ToString();
            if (name == "None") continue;
            GroupRider model = new GroupRider();
    ...
    public Dictionary<string, GroupRider> LoadJson(string Filepath)
    {
        StreamReader reader = new StreamReader(Filepath);
        string jsonString = reader.ReadToEnd();
        Dictionary<string, GroupRider> audioGroup = JsonMapper.ToObject<Dictionary<string, GroupRider>>(jsonString);
        reader.Dispose();
        reader.Close();
        return audioGroup;
    }
    ...
    {
        Dictionary<string, GroupRider> dic = new Dictionary<string, GroupRider>();
        MergeDictionaries.Giant(dic, UIAudioGroup);
        MergeDictionaries.Giant(dic, SceneAudioGroup);
